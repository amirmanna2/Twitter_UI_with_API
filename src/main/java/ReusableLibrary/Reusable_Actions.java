...
public class Reusable_Actions {
    ...
    public static void clickOnElement(WebDriver driver, String xpathLocator, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            logger.log(LogStatus.PASS,"Successfully clicked on a element " + elementName);
        } catch (Exception e) {
    ...
    public static void hoverOverElement(WebDriver driver, String xpathLocator, ExtentTest logger, String elementName) {
        //define by explicit wait
        WebDriverWait wait = new WebDriverWait(driver, 20);
    ...
    public static String clickOnHoverElement(WebDriver driver,String xpath,int index,ExtentTest logger, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,10);
        String result = "";
        try{
